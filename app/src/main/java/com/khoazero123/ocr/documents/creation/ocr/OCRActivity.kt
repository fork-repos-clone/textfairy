...
import com.khoazero123.ocr.MonitoredActivity
import com.khoazero123.ocr.R
import com.khoazero123.ocr.databinding.ActivityOcrBinding
import com.khoazero123.ocr.documents.creation.DocumentStore.saveDocument
import com.khoazero123.ocr.documents.creation.NewDocumentActivity
import com.khoazero123.ocr.documents.creation.NewDocumentActivity.EXTRA_IMAGE_SOURCE
import com.khoazero123.ocr.documents.creation.ProgressDialogFragment
import com.khoazero123.ocr.documents.creation.crop.BlurWarningDialog
import com.khoazero123.ocr.documents.creation.crop.CropImageFragment
import com.khoazero123.ocr.documents.creation.crop.CropImageFragment.Companion.HINT_DIALOG_ID
import com.khoazero123.ocr.documents.creation.ocr.ImageLoadingViewModel.ImageLoadStatus
import com.khoazero123.ocr.documents.creation.ocr.ImageLoadingViewModel.ImageLoadStatus.*
import com.khoazero123.ocr.documents.creation.ocr.LayoutQuestionDialog.LayoutChoseListener
import com.khoazero123.ocr.documents.creation.ocr.LayoutQuestionDialog.LayoutKind
import com.khoazero123.ocr.documents.creation.ocr.LayoutQuestionDialog.LayoutKind.COMPLEX
import com.khoazero123.ocr.documents.creation.ocr.LayoutQuestionDialog.LayoutKind.SIMPLE
import com.khoazero123.ocr.documents.viewing.single.DocumentActivity.EXTRA_ACCURACY
import com.khoazero123.ocr.documents.viewing.single.DocumentActivity.EXTRA_LANGUAGE
